...
addLabel("labeltext", "Go Label: ")
  addTextEdit("labeltext", storage.golabelName or "player name",
  function(widget, text)     storage.golabelName= text end)

UI.Button(
  "Go Label",
  function()
	CaveBot:setOn()
    CaveBot.gotoLabel(storage.golabelName)
	CaveBot:setOff()
  end
)
UI.Button(
