...
addCheckBox("pet", "Reboot/Restart fix", true, rightPanel, "Say !pet at login.")
if true then
  local summoned = false
  onTextMessage(function(mode,text) 
    if not settings.pet then return end
    
    text = text:lower()

    if text == "Pet is already summoned." then
      summoned = true
    end
  end)
