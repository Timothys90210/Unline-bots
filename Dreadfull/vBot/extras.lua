...
UI.Button("Outfit Id", function()
    say("outfit = "..player:getOutfit().type..", mount = "..player:getOutfit().mount..", head = "..player:getOutfit().head..", body = "..player:getOutfit().body..", legs = "..player:getOutfit().legs..", feet = "..player:getOutfit().feet)
end)
...
if true then
  ...
  if voc() == 4 or voc() == 104 then
      vocText = "- EK"
  elseif voc() == 3 or voc() == 103 then
      vocText = "- RP"
  elseif voc() == 1 or voc() == 101 then
      vocText = "- MS"
  elseif voc() == 2 or voc() == 102 then
      vocText = "- ED"
  elseif voc() == 7 or voc() == 107 then
      vocText = "- NJ"
  end
...
if true then
  local doorsIds = { 1674, 1644, 5111, 5113, 5102, 1680, 1631, 1676, 8363, 7723, 8361, 5007, 8265, 1629, 1632, 5129, 6252, 6249, 7715, 7712, 7714, 
                     7719, 6256, 1669, 1672, 5125, 5115, 5124, 17701, 17710, 1642, 
                     6260, 5107, 4912, 6251, 5097, 5291, 1683, 1696, 1692, 5006, 2179, 5116, 
  ...
  onTextMessage(function(mode, text)
    ...
    if #re ~= 0 then
        ...
        if text:lower():find("sorcerer") then
            voc = "MS"
        elseif text:lower():find("alchemist") then
            voc = "MS"
        elseif text:lower():find("druid") then
            voc = "ED"
        elseif text:lower():find("biochemist") then
            voc = "ED"
        ...
        elseif text:lower():find("paladin") then
            voc = "RP"
        elseif text:lower():find("sniper") then
            voc = "RP"
        elseif text:lower():find("ninja") then
            voc = "NJ"
        elseif text:lower():find("thief") then
            voc = "NJ"
        else
            voc = "??" -- Valor por defecto si no se detecta vocación
        end
